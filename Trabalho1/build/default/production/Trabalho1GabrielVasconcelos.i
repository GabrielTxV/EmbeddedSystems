# 1 "Trabalho1GabrielVasconcelos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Trabalho1GabrielVasconcelos.c" 2
# 10 "Trabalho1GabrielVasconcelos.c"
# 1 "./configbits.h" 1
...
# 10 "Trabalho1GabrielVasconcelos.c" 2
...
# 12 "Trabalho1GabrielVasconcelos.c" 2
...
void processamento(void) {
# 119 "Trabalho1GabrielVasconcelos.c"
    if (borda_d & 0b00001000){
        if(PORTB & 0b00010000){
            if(PORTB & 0b00100000){
               switch(numero){
                    case 0:
